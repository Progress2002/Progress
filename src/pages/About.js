            ...
            <div className="lg:w-[60%]">
              ...
              <Slide direction="up" triggerOnce="true">
                <p className="mb-6 text-lg font-normal text-text lg:text-xl">
                  ...
                  as a Full-stack Web Developer. I harness the latest
                  technologies and design systems to create interactive
                  solutions that captivate both clients and companies. My core
                  goal is to deliver top-notch, user-friendly, and highly
              ...
              <Slide direction="up" triggerOnce="true">
                <p className="mb-6 text-lg font-normal text-text lg:text-xl">
                  ...
                  websites has been my driving force for months. During this
                  time, I've empowered various clients to establish their online
                  presence. I am also an avid enthusiast of open-source
                  software, continually seeking internships and projects to
                  further enhance my skills and gain valuable experience in
              ...
              <Slide direction="up" triggerOnce="true">
                <Fade delay={300} triggerOnce="true">
                  <div
                    ...
                    border-sc_color backdrop-blur-sm z-20 before:absolute before:bg-white/20
                      before:w-full before:duration-500 before:left-5 before:top-5 before:-bottom-5
                      before:-z-20 before:rounded-md hover:before:left-3 hover:before:top-3 hover:before:-bottom-3">
                    <img
                      src={profile}
                      alt="profile image"
