...
const Home = () => (
  <div className="min-h-full mb-7">
    <div className="lg:container mx-7 lg:mx-auto">
      ...
      <Slide
        direction="up"
        className="max-w-[40.75rem]"
        triggerOnce="true"
        duration="1500">
        <p
          className="text-text_Light text-lg md:text-xl md:leading-[1.5] mt-6"
          style={{ opacity: 1 }}>
          As a <span className="text-sc_color">Full-stack</span> web developer,
          I possess a diverse skill set that empowers me to create and deploy{" "}
          ...
          with business objectives. My dedication to user satisfaction drives me
          to deliver the best, most functional, and enduring solutions that
