...
const Project = () => {
  ...
  return (
    <div className="min-h-full my-10 lg:my-20 lg:container">
      <div className=" text-start mx-3 md:mx-20 lg:mx-auto">
        <h2 className="mb-16 text-3xl sm:text-[3.5rem] lg:text-4xl
          md:leading-[1.3] font-semibold text-center text-text md:text-5xl ">
        ...
        <ul className="flex flex-col gap-14 lg:gap-20">
